...
/**
 * Classe que representa a tela de Importação de Lista de Série.
 *
 * @author Breno
 */
public class TelaImportarLista {
    ...
    private void adicionarComponentes() {
        ...
        btnImportarLista = new JButton(I18N.obterBotaoImportar(),
    ...
    private void configurarEventosTela() {
        ...
        btnImportarLista.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (!listaSerie.getNome().equals(txtNomeLista.getText())) {
                    ...
                    if (gerenciadorListaSeries.isCamposCorretos(listaSerie)) {

                        gerenciadorListaSeries.cadastrarListaSeries(listaSerie);

                        Utilidades.msgInformacao(I18N.obterSucessoImportarListaSerie());

                        janela.dispose();
                    }

                } else {
                    Utilidades.msgErro(I18N
                            .obterErroImportarListaSerie());
                }
            }
        });
    }
